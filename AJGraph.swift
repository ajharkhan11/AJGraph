...
//  ChartDemo
//
//  Created by Azharudeen on 25/02/19.
...
public class AJGraph: UIView {
    
    //define arc property
    public var arcWidth:CGFloat = 10.0
    public var arcColor = UIColor.yellow
    public var arcBackgroundColor = UIColor.black
    
    //define start angle and end angle
    var parentEndArc = CGFloat(360).deg2rad// CGFloat(180 * Double.pi / 180)
    var start:CGFloat = CGFloat(0).deg2rad
    var childEndArc:CGFloat = CGFloat(270).deg2rad{   // in range of 0.0 to 1.0
        didSet{
            setNeedsDisplay()
        }
    }
